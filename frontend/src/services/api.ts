...
export const cadastroAPI = {
  ...
  updateMotorista: (id: number, data: any) => axios.put(`${CADASTRO_API}/motoristas/${id}`, data),
  deleteMotorista: (id: number) => axios.delete(`${CADASTRO_API}/motoristas/${id}`),
...
export const roteirizacaoAPI = {
  ...
  deleteRota: (id: number) => axios.delete(`${ROTEIRIZACAO_API}/rotas/${id}`),
